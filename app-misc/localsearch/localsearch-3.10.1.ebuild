...
DESCRIPTION="Localsearch is an efficient search engine for desktop, embedded and mobile"
...
IUSE="cue exif ffmpeg gif gsf +gstreamer iptc +iso +jpeg +pdf +playlist raw seccomp test +tiff upower +xml xmp xps"
...
RDEPEND="
	...
	dev-libs/libgudev
	>=app-misc/tinysparql-3.8_alpha:3
