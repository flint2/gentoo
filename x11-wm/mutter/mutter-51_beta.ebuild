...
# native backend requires gles3 for hybrid graphics blitting support, udev and a provider
REQUIRED_USE="
	|| ( X wayland )
	devkit? ( screencast wayland )
	gtk-doc? ( introspection )
	wayland? ( ^^ ( systemd ) udev )
...
RDEPEND="
	...
	>=gnome-base/gsettings-desktop-schemas-51_beta[introspection?]
