...
COMMON_DEPEND="
	>=dev-libs/glib-2.90:2[introspection?]
	>=x11-libs/cairo-1.18.2[aqua?,glib,svg(+),X?]
	>=x11-libs/pango-1.58.0[introspection?]
	...
	gstreamer? (
		>=media-libs/gstreamer-1.28.0:1.0
		>=media-libs/gst-plugins-bad-1.28.0:1.0
		|| (
			>=media-libs/gst-plugins-base-1.28.0:1.0[gles2]
			>=media-libs/gst-plugins-base-1.28.0:1.0[opengl]
		)
	)
