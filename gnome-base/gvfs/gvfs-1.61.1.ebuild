...
IUSE="afp archive bluray cdda elogind fuse +gcr google keyring gnome-online-accounts gphoto2 +http ios mtp nfs onedrive policykit samba +sftp systemd test +udev udisks zeroconf"
RESTRICT="!test? ( test )"
...
RDEPEND="
	...
	gnome-online-accounts? ( >=net-libs/gnome-online-accounts-3.57.0:= )
