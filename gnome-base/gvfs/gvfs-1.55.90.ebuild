...
IUSE="afp archive burn bluray cdda elogind fuse google keyring gnome-online-accounts gphoto2 +http ios onedrive mtp nfs policykit samba systemd test +udev udisks zeroconf"
RESTRICT="!test? ( test )"
