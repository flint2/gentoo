...
IUSE="+archive bash-completion bluetooth cbor flashrom gnutls gtk-doc introspection minimal modemmanager policykit readline seccomp spi systemd test tpm uefi"
