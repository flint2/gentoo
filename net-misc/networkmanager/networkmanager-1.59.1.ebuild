...
"
SRC_URI="https://gitlab.freedesktop.org/NetworkManager/NetworkManager/-/releases/${PV}-dev/downloads/${MY_PN}-${PV}-dev.tar.xz"
S="${WORKDIR}"/${MY_PN}-${PV}
...
src_unpack() {
	default
	mv NetworkManager-1.59.1-dev NetworkManager-1.59.1
}
