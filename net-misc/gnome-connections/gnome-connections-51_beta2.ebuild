...
SRC_URI="https://download.gnome.org/sources/gnome-connections/51/gnome-connections-51.beta2.tar.xz"
...
src_unpack() {
	default
	mv gnome-connections-51.beta2 gnome-connections-51.beta.2
}
